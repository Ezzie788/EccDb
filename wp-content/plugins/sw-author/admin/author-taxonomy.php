...
function sw_author_social_meta(){
		...
		$instagram = get_post_meta( $post->ID, 'social', true );
...
function sw_author_save_meta( $post_id ){
	...
	$facebook  = isset( $_POST['facebook'] ) ? $_POST['facebook'] : array();
	$twitter  = isset( $_POST['twitter'] ) ? $_POST['twitter'] : array();
	$linkedin  = isset( $_POST['linkedin'] ) ? $_POST['linkedin'] : array();
	$gplus  = isset( $_POST['gplus'] ) ? $_POST['gplus'] : array();
	$age  = isset( $_POST['age'] ) ? $_POST['age'] : array();
	$languages  = isset( $_POST['languages'] ) ? $_POST['languages'] : array();
	$bookpl  = isset( $_POST['bookpl'] ) ? $_POST['bookpl'] : array();
