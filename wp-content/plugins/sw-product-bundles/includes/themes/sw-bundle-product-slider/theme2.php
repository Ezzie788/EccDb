								...
								<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
									<?php 
										...
										if ( has_post_thumbnail() ){
												echo get_the_post_thumbnail( $post->ID, 'full' ) ? get_the_post_thumbnail( $post->ID, 'full' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'full'.'.png" alt="No thumb">';		
										}else{
