...
if ( isset( $wp_version ) && version_compare( $wp_version, '3.5' ) >= 0 ) {
	function sw_image_resize( $url, $width = NULL, $height = NULL, $crop = true, $retina = false ) {
 ...
 */
add_action( 'delete_attachment', 'sw_delete_resized_images' );
function sw_delete_resized_images( $post_id ) {
