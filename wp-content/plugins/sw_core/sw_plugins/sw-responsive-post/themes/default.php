							...
							<div class="img_over">
								<a href="<?php echo get_permalink($post->ID)?>" >
									...
									if ( has_post_thumbnail( $post->ID ) ){
										...
										echo get_the_post_thumbnail( $post->ID, 'emarket_blog-responsive2' ) ? get_the_post_thumbnail( $post->ID, 'emarket_blog-responsive2' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
									}else{
