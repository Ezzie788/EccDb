						...
						<div class="item-detail">
							<div class="item-thumb">
								...
								if ( has_post_thumbnail( $item->ID ) ){
									...
									echo get_the_post_thumbnail( $item->ID, array(108,60) ) ? get_the_post_thumbnail( $item->ID, array(108,60) ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'thumbnail2'.'.png" alt="No thumb">';		
								}else{
