							...
							<?php if( $i == 0 ) : ?>
								...
								<div class="img_over">
									...
									if ( has_post_thumbnail( $post->ID ) ){
											...
											echo get_the_post_thumbnail( $post->ID, array(350,233) ) ? get_the_post_thumbnail( $post->ID, array(350,233) ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
									}else{
