								...
								<div class="item-detail">
									...
									<div class="img_over">
										...
										if ( has_post_thumbnail( $post->ID ) ){
												...
												echo get_the_post_thumbnail( $post->ID, array(560,290) ) ? get_the_post_thumbnail( $post->ID, array(560,290) ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
										}else{
