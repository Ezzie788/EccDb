...
?>
	<div id="<?php echo esc_attr( $widget_id.rand() ) ?>" class="responsive-slider sw-brand-container-slider2 <?php echo esc_attr( $style ); ?> loading clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>" data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
		<?php if( $title1 != '') { ?>
			...
			<div class="slider responsive">
				...
				<?php } ?>
						...
						<div class="item-content">
							<h4><a href="<?php echo get_term_link( $term->term_id, 'product_brand' ); ?>"><?php echo $term->name;?></a></h4>
							<a class="shop-brand" href="<?php echo get_term_link( $term->term_id, 'product_brand' ); ?>"><?php echo esc_html__('Shop this brand','sw_woocommerce');?></a>
						</div>
