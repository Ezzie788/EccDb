				...
				<?php } ?>
									...
									<div class="item-wrap">
										<div class="item-detail">	
											<div class="item-img products-thumb">
													<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php echo get_the_post_thumbnail( $product->get_id(), 'shop_catalog' ); ?></a>
					...
					<div class="item-bottom clearfix">
							<div class="item-user">
								...
								<h4>
									<a href="<?php echo esc_url( WCV_Vendors::get_vendor_shop_page( $user->ID ) ); ?>"><?php echo ( get_user_meta( $user->ID, 'pv_shop_name', true ) ) ? get_user_meta( $user->ID, 'pv_shop_name', true ) : $user->user_nicename; ?></a>
