...
if ( !class_exists('sw_woo_tab_slider_widget') ) {
		...
		function SC_integrateWithVC(){
			...
			vc_map( array(
				...
				array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Style1' => 'theme1' ),
	...
	<?php 
		...
		?>
			<?php if( $layout == 'theme1') :?>

			<div id="<?php echo esc_attr( 'tab_'. str_replace( '%', '', $target ) ); ?>" class="woo-tab-container-slider responsive-slider clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
			...
			<?php elseif( $layout == 'theme3' || $layout == 'theme5' ) :?>
				<div id="<?php echo esc_attr( 'tab_'. str_replace( '%', '', $target ) ); ?>" class="woo-tab-container-slider responsive-slider clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
					<div class="resp-slider-container">
							<div class="slider responsive">
						<?php 
			...
			<?php elseif( $layout == 'theme6' ) :?>
				...
				<?php if( count( $x_array ) > 0 ) : ?>
					<div id="<?php echo esc_attr( 'brand_' . str_replace( '%', '', $target ) ); ?>" class="responsive-slider banner-slider loading" data-lg="4" data-md="2" data-sm="3" data-xs="2" data-mobile="1" data-arrow="false" data-fade="false">
						<div class="slider responsive">
							<?php 
								...
								if( $key > 4 ){
									...
									$thumb = wp_get_attachment_image( $thumbnail_id, array(150, 104) );
				...
				<!-- Brand -->
				<?php if( count( $x_array ) > 0 ) : ?>
					<div id="<?php echo esc_attr( 'brand_' . str_replace( '%', '', $target ) ); ?>" class="responsive-slider banner-slider loading" data-lg="5" data-md="3" data-sm="3" data-xs="2" data-mobile="1" data-arrow="false" data-fade="false">
						<div class="slider responsive">
							<?php 
								$x_array = array_unique( explode( ',', $z_array ) );
								foreach( $x_array as $key => $cat ) {
								if( $key > 5 ){
									...
									$thumbnail_id 	= absint( get_term_meta( intval( $cat ), 'thumbnail_bid', true ) );
									$thumb = wp_get_attachment_image( $thumbnail_id, array(155, 90) );
									$thubnail = ( $thumb != '' ) ? $thumb : '<img src="http://placehold.it/170x90" alt=""/>';
							?>
							<div class="item-brand">
								<a href="<?php echo get_term_link( intval( $cat ), 'product_brand' ); ?>"><?php echo $thubnail ?></a>
			...
			<div id="<?php echo esc_attr( 'tab_'. str_replace( '%', '', $target ) ); ?>" class="woo-tab-container-slider responsive-slider clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
				...
				<a class="view-all" href="<?php echo esc_url( $viewall ); ?>" title="<?php esc_html_e( 'Show More', 'sw_woocommerce' ) ?>">+ <?php echo esc_html__('Show More','sw_woocommerce');?></a>
			</div>
			
			<?php elseif( $layout == 'theme10') :?>
			<div id="<?php echo esc_attr( 'tab_'. str_replace( '%', '', $target ) ); ?>" class="woo-tab-container-slider responsive-slider clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
				<div class="resp-slider-container">
					<div class="slider responsive">
					<?php 
	...
	<?php 
		...
		public function form( $instance ) {
			...
			<?php if ( $widget_template=='theme7' || $widget_template=='theme4'){ ?>
		
			<p>
				<label for="<?php echo $this->get_field_id('style'); ?>"><?php _e('Style', 'sw_woocommerce')?></label>
				<br />
				<?php $allowed_keys = array('' => 'Default', 'style1' => 'Style1'); ?>
			...
			<?php if ( $widget_template=='theme4' || $widget_template=='theme6' || $widget_template=='theme7'){ ?>
