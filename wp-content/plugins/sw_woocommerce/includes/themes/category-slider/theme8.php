...
<div id="<?php echo 'slider_' . $widget_id; ?>" class="responsive-slider sw-category-slider8 loading"  data-append=".resp-slider-container" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
	...
	<div class="box-title">
		...
		<h3><span><?php echo $title2; ?></span></h3>
	</div>
	<?php } ?>
			...
			<div class="item item-product-cat">
				<div class="item-wrap">
					...
					<div class="item-content">
						<h3><a href="<?php echo get_term_link( $term->term_id, 'product_cat' ); ?>"><?php sw_trim_words( $term->name, $title_length ); ?><span class="product-count"><?php echo ( ($term->count) < 10 ? '0'.esc_attr( $term->count) : $term->count ); ?></span></a></h3>
					</div>
				</div>
			</div>
			<?php endif; ?>
