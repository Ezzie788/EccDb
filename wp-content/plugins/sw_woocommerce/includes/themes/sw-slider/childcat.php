...
if ( $list -> have_posts() ){ ?>
	<div id="<?php echo $id; ?>" class="responsive-slider sw-child-cat <?php echo esc_attr( $style );?> loading" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
		<div class="child-top clearfix">
			...
			<div class="childcat-content pull-right"  id="<?php echo 'child_' . $id; ?>">
				<?php 					
					echo '<ul>';
					echo '<li>' .esc_html__('Top 10 Items', 'sw_woocommerce') . '</li>';
