...
?>
<div class="sw-woo-tab-cat8 sw-ajax" id="<?php echo esc_attr( 'category_' . $widget_id ); ?>" >
	<div class="resp-tab" style="position:relative;">
		<div class="top-tab-slider clearfix">
			<?php if( $title1 != '' ){
				?>
				<div class="box-title"><h3 class="custom-font"><?php echo ( $title1 != '' ) ? $title1 : $term_name; ?></h3></div>
				<?php } ?>
