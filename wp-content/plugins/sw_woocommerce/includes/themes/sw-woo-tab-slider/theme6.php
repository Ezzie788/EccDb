<?php 
	...
	//$widget_id = 'tab7_'.rand().time();
?>
<div class="sw-wootab-slider sw-ajax sw-woo-tab-style7 clearfix" id="<?php echo esc_attr( $widget_id ); ?>" >
	<div class="tab-top">
				...
				<?php 
					...
					<div class="childcat-content"  id="<?php echo 'child_' . $widget_id; ?>">
						<?php 					
							...
							echo '<li><a href="' . $viewall . '">' . esc_html__('View all','sw_woocommerce') . '</a></li>';
							echo '</ul>';
						?>
					</div>
					<?php } ?>
	...
	<div class="resp-tab" style="position:relative;">
		...
		<!-- Product tab slider -->						
			...
			?>
				...
				<div id="<?php echo esc_attr( 'brand_' . $widget_id ); ?>" class="responsive-slider banner-slider loading" data-lg="4" data-md="2" data-sm="3" data-xs="2" data-mobile="1" data-arrow="false" data-fade="false">
					<div class="slider responsive">
							<?php 
