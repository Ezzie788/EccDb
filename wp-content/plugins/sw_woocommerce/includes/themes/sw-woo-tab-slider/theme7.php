...
?>
<div class="sw-wootab-slider sw-ajax sw-woo-tab-style8 <?php echo $style; ?>" clearfix" id="<?php echo esc_attr( $widget_id ); ?>" >
	<div class="tab-top">
			...
			<!-- Product tab slider -->						
				...
				?>
					...
					<?php if( count( $x_array ) > 0 ) : ?>
						<div id="<?php echo esc_attr( 'brand_' . $widget_id ); ?>" class="responsive-slider banner-slider loading" data-lg="5" data-md="3" data-sm="3" data-xs="2" data-mobile="1" data-arrow="false" data-fade="false">
							<div class="slider responsive">
								<?php 
